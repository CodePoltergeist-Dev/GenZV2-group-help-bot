...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/joefreddiecheeran/Group-Manager-Bot)
...
class Development(Config):
    OWNER_ID = 000000000  # my telegram ID. (you can find it using 'userinfobot' bot)
    OWNER_USERNAME = "yourid"  # my telegram username
